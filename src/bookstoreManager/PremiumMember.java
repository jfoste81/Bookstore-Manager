...
public class PremiumMember{
     ...
     * @param purchaseAmount the total amount of money this member has spent at the shop
     * @param hasPaidDues boolean to see if the member has paid the premium membership fee
     */
    public PremiumMember(String name, int numPurchases, double amountSpent, boolean hasPaidDues){
        this.name = name;
    ...
    /**
     * Getter for the purchaseAmount field
     *
    ...
    /** 
     * Getter for the hasPaidDues field
     *
     * @return if the member has paid their premium membership as a boolean
     */
    ...
    /**
     * Setter for the hasPaidDues field
     *
     * @param hasPaidDues the truth value for if the user has paid their premium membership fee
     */
